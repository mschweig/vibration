...
LOG_MODULE_REGISTER(mpu6050, CONFIG_UI_LOG_LEVEL);
...
void cmsis_dsp_test(){ 
	...
	//detrend the signal
	arm_mean_f32(testInput,NFFT,&mean);
	arm_offset_f32(testInput,mean,testInput,NFFT);
	...
	//delete dc offset
	testOutput[0] = 0;
	arm_abs_f32(testOutput, testOutput, NFFT);
	arm_max_f32(testOutput,NFFT, &maxValue, &testIndex);
